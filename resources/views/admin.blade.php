...
<body style='background-color: rgb(241 245 249);'>
    <div class="flex justify-center mt-10">
        <div class=' bg-white w-2/4 p-5'>
            <h1 class='text-2xl text-center'>Admin</h1>
            ...
            <div>
                ...
                <input type="text" name='title'  class="bg-gray-100 h-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="title" required>
            </div>
            <div>
                <label for="first_name" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link :</label>
                <input type="text" name='link'  class="bg-gray-100 h-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Link" required>
            </div>
            <div>
            ...
            <button class='mt-10 bg-green-500 w-64 h-10 rounded-xl '>Save</button>
